    ...
    <v-card variant="text" v-if="recipe">
      <v-row :class="$vuetify.display.mobile ? '' : 'mt-6'">
        <v-col :cols="$vuetify.display.mobile ? 12 : 6">
          <v-img style="border-radius: 4px;" :src="recipe.image" :alt="recipe.title" :height="$vuetify.display.mobile ? '250px' : '350px'" cover class="mb-3">
            <v-btn
              icon
              class="ma-2"
            ...
            <v-col cols="6">
              ...
              >
                ...
                <v-btn-toggle
                  ...
                  group
                >
                  <v-btn height="35" value="metric" style="font-weight: bold; letter-spacing: normal; text-transform: capitalize;">
                    Metric
                  </v-btn>
  
                  <v-btn height="35" value="us" style="font-weight: bold; letter-spacing: normal">
                    US
                  </v-btn>
                </v-btn-toggle>
              </div>
      ...
      <p class="text-h6 font-weight-bold mb-4" style="line-height: normal">{{ recipe.title }}</p>
      ...
      <div>
        <div v-if="recipe.summary && $vuetify.display.mobile" class="summary-container">
          ...
          <div style="width: 100%" class="d-flex align-center justify-center">
            <span style="text-align: center; font-weight: bold; font-size: 14px" @click="toggleExpand" v-if="!expanded">
              Show More <v-icon>mdi-chevron-down</v-icon>
            </span>
          </div>
        </div>
        <div v-else-if="recipe.summary && !$vuetify.display.mobile" v-html="recipe.summary"></div>  
          ...
          <v-col cols="6">
            ...
            >
              ...
              <v-btn-toggle
                ...
                group
              >
                <v-btn height="35" value="metric" style="text-transform: capitalize;">
                  Metric
                </v-btn>

                <v-btn height="35" value="us">
                  US
                </v-btn>
              </v-btn-toggle>
            </div>
        ...
        <v-row class="mb-4 mt-4">
          <v-col :cols="$vuetify.display.mobile ? 12 : 6">
            <div v-if="recipe.extendedIngredients">
              ...
              <div v-for="ingredient in adjustedIngredients" :key="ingredient.id">
                <p style="font-size: 14px">
                  <strong>{{ formatAmountToFraction(ingredient.adjustedAmount) }} {{ ingredient.adjustedUnit }}</strong>
                  {{ ingredient.originalName }}
                </p>
                <div style="width: 100%; border-bottom: 1px dashed #757575; margin-top: 5px; margin-bottom: 5px"></div>
              </div>
            </div>
          </v-col>
          <v-col :cols="$vuetify.display.mobile ? 12 : 6">
...
export default {
  ...
  data() {
    return {
      ...
      "readyInMinutes": 35,
      "servings": 3,
      "sourceUrl": "https://www.foodista.com/recipe/H5NJNDP7/chicken-tortilla-soup-with-bone-broth",
      "vegetarian": false,
      "vegan": false,
      "glutenFree": true,
      "dairyFree": true,
      ...
      "spoonacularSourceUrl": "https://spoonacular.com/chicken-tortilla-soup-with-bone-broth-1096226"
    },
      expanded: false,
    };
  },
  ...
  computed: {
    ...
    return this.recipe.extendedIngredients.map((ingredient) => {
      ...
      const baseMeasure = this.scale == 'metric'
